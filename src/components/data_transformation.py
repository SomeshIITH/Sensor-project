...
class DataTransformationConfig:
    ...
    transformed_test_file_path = os.path.join(artifact_dir,'test.npy')   #train.npy to store train data in numpy format
    transformed_object_file_path = os.path.join(artifact_dir,'preprocessor.pkl')   #preprocessor.pkl to store object
